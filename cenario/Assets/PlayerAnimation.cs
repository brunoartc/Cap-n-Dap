...
public class PlayerAnimation : MonoBehaviour
{
    ...
    public string[] staticDirections = { "StaticN", "StaticW", "StaticS", "Static E" };
    ...
    public void SetDirection(Vector2 _direction)
    {
        ...
        else
        {
            ...
            lastDirection = DirectionToIndex(_direction)/2;//MARKER Get the index of the slcie from the direction vector
            if(lastDirection<0){
                lastDirection=0;
            }
        }
